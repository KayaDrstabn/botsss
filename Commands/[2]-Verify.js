...
Now you are ready! 👅`, components: [row]});
      ...
      if(button.values[0] === "nsfw") {
        ...
        .setColor('2F3136')
        .setDescription(`Hello👋, Click The ”🍑 NSFW Access” Button To Confirm That You Are 18 Years Or Older And That You Consent To Viewing Sexually Content. 🌸`)
        .setImage("https://media.discordapp.net/attachments/1200359071774146591/1200775874866323526/Screenshot_20230128_152942.png?ex=65c768ad&is=65b4f3ad&hm=31c6a0c4db35908789744db26b63abdb838026d7ebdd282af586c1c994c0c849&")
        let btn = new ButtonBuilder()
        .setStyle(ButtonStyle.Link)
        .setURL(client.authLink)
        .setLabel("Verify");
...
Verify Your Self By [Click here to Verify!](${client.authLink})`)
        .setColor('2F3136')
        .setImage("https://cdn.discordapp.com/attachments/1250036847598501921/1250100938522234890/nitromonth.PNG?ex=6678dff9&is=66778e79&hm=2945b4fc1e85d23a367f53c5635db8e5fd6f20a794ddc84943f2ce898cbd6ba3&")
        let btn = new ButtonBuilder()
        .setStyle(ButtonStyle.Link)
        .setURL(client.authLink)
        .setLabel("Verify");
      ...
      if(button.values[0] === "normal") {
        ...
        .setColor('2F3136')
        .setImage("https://cdn.discordapp.com/attachments/1051195263311687870/1237078230192623728/aesthetic-verify.gif?ex=6661e361&is=666091e1&hm=e4be4d8ce4d502777b9ef6d92e5facf314a75b3feae5b8e0a139233945e4dd37&")
        let btn = new ButtonBuilder()
        .setStyle(ButtonStyle.Link)
        .setURL(client.authLink)
        .setLabel("Verify");
